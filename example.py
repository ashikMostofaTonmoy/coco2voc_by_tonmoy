...
if __name__ == '__main__':
    ...
    annotations_file = "data/input/motorcycle (pixel) Sep 15 2022 18-11 Acme Project(panoptic)/COCO_motorcycle (pixel).json"
    labels_target_folder = 'data/output/motorcycle(panoptic)'
    # data_folder = '/home/dl/1TB-Volumn/MSCOCO2017/train2017'
    data_folder = 'data/input/motorcycle (pixel) Sep 15 2022 18-11 Acme Project(panoptic)/images'
